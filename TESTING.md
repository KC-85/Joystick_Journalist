...
| Directory | File | URL | Screenshot | Notes |
| --- | --- | --- | --- | --- |
| core | [settings.py](https://github.com/KC-85/Joystick_Journalist/blob/main/core/settings.py) | [PEP8 CI Link](https://pep8ci.herokuapp.com/https://raw.githubusercontent.com/KC-85/Joystick_Journalist/main/core/settings.py) | ![screenshot](documentation/validation/py-core-settings.png) | Notes (if applicable) |
...
|  | [erd.py](https://github.com/KC-85/Joystick_Journalist/blob/main/erd.py) | [PEP8 CI Link](https://pep8ci.herokuapp.com/https://raw.githubusercontent.com/KC-85/Joystick_Journalist/main/erd.py) | ![screenshot](documentation/validation/py--erd.png) | Notes (if applicable) |
|  | [manage.py](https://github.com/KC-85/Joystick_Journalist/blob/main/manage.py) | [PEP8 CI Link](https://pep8ci.herokuapp.com/https://raw.githubusercontent.com/KC-85/Joystick_Journalist/main/manage.py) | ![screenshot](documentation/validation/py--manage.png) | Notes (if applicable) |
...
| Edit Game | ![screenshot](documentation/responsiveness/mobile-edit-blog.png) | ![screenshot](documentation/responsiveness/tablet-edit-blog.png) | ![screenshot](documentation/responsiveness/desktop-edit-blog.png) | Works as expected |
