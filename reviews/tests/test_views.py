...
class LandingPageViewTest(TestCase):
    ...
    def setUp(self):
        ...
        Game.objects.create(title="Super Metroid", release_year=1994, genre="Action")
...
class ReviewPageViewTest(TestCase):
    ...
    def setUp(self):
        self.game = Game.objects.create(title="Killer Instinct", release_year=1994, genre="Fighting")
