...
from .forms import GameForm, ReviewForm  # Fixed incorrect import
...
def review_page(request, game_id):
    game = get_object_or_404(Game, id=game_id)  # Fetch game or return 404
